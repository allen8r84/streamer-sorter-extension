...
const sortingModule = (() => {
  ...
  // Extract time value from an li element and convert it to minutes - USING ORIGINAL FUNCTION
  function extractTimeInMinutes(li) {
    // Find the time span within the li - USING ORIGINAL SELECTOR
  ...
  // Extract viewer count from an li element - USING ORIGINAL FUNCTION
  function extractViewerCount(li) {
    // Find the viewers span within the li - USING ORIGINAL SELECTOR
  ...
  // Sort room list items by priority and selected sort criteria - USING ORIGINAL FUNCTION
  function sortListItems(sortBy = 'time', order = 'desc') {
    ...
    // Select the main list - USING ORIGINAL SELECTOR
    ...
    // Convert NodeList to array for easier manipulation - USING ORIGINAL SELECTOR
